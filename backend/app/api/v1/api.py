...
api_router_v1.include_router(
    history.router, prefix="/sessions", tags=["Session History"]
)
api_router_v1.include_router(
    patient_data.router, prefix="/patient-data-logs", tags=["Patient Data Logs"]
)
api_router_v1.include_router(
    user_profiles.router, prefix="/users", tags=["User Profiles"]
)
