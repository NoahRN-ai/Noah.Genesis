...
class Settings(BaseSettings):
    ...
    DEFAULT_LLM_MODEL_NAME: str = "gemini-1.0-pro-001" # Or specific version like "gemini-1.0-pro-001"
    ...
    FIREBASE_SERVICE_ACCOUNT_JSON_PATH: Optional[str] = None # Path to service account file
